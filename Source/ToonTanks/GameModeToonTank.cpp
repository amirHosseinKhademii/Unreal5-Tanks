...
void AGameModeToonTank::BeginPlay()
{
    Super::BeginPlay();
    HandleGameStart();
}

void AGameModeToonTank::ActorDied(AActor *DeadActor)
{
    if (DeadActor == Tank)
    {
...
void AGameModeToonTank::HandleGameStart()
{
...
int32 AGameModeToonTank::GetTargetTowerCount()
{
